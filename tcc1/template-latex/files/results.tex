...
Levando em conta estas sugestões, averiguou-se também a utilização das redes LeNet e AlexNet com a função de ativação \emph{Leaky ReLU} na camada de saída, cujos resultados encontram-se descritos na Tabela \ref{tab:results_leaky}.
